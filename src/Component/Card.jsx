...
<div className="flex items-center gap-3 mt-3">
  ...
  {/* Add to Cart Button */}
  <button className="flex-1 flex text-xs items-center text-nowrap  justify-center gap-2 border border-black text-black py-2 rounded-xl hover:bg-black hover:text-white transition duration-300 font-medium">
    <ShoppingCart size={18} />
    Add to Cart
  </button>
